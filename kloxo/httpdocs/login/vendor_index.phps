...
if($cgi_class) $cgi_classname = $cgi_classname;
    ...
    <table width="100%" height="64" border="0" valign="top" align="center" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td height="64" width="20%">
                <img src="/img/header/header_02.gif" width="194" height="64">
            </td>
            <td width="20%" height="64">
                <img src="/img/header/<?php echo $progname ?>-header.gif" width="238" height="64">
            </td>
            <td width="20%" height="64">
                <img src="/img/header/header_04.gif" width="10" height="64">
            </td>
        </tr>
        <tr>
            <td width="100%" colspan="5" bgcolor="#003366" width="10" height="2">
            </td>
        </tr>
    </table>
<?php
