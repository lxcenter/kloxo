...
yes | cp -rf ./patch/kloxo/* /usr/local/lxlabs/kloxo
yes | cp -rf /usr/local/lxlabs/kloxo/pscript /script
yes | cp -rf /usr/local/lxlabs/kloxo/httpdocs/htmllib/script /script
