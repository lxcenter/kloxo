...
$__description["Command"] = array("Comandos");
$__description["Confirm"] = array("Confirmar");
$__description["Output"] = array("Salida");
...
$__description["switch_server"] = array("Intercambiar servidor");
$__description["change_owner"] = array("Cambiar propietario");
$__description["get_backup"] = array("Obtener respaldo");
$__description["restore"] = array("Restaurar");
$__description["logout"] = array("Salir");
$__description["Change Name"] = array("Cambiar nombre");
$__description["switch_status"] = array("Intercambiar estado");
$__description["server_details"] = array("Detalles del servidor");
$__description["date"] = array("Fecha");
$__description["quota_view"] = array("Vista de cuota");
$__description["normal_view"] = array("Vista normal");
$__description["last_switch_status"] = array("�ltimo intercambio de estado");
$__description["Backup_File"] = array("Archivo de respaldo");
$__description["dns_record"] = array("Registro Dns");
$__description["value"] = array("Valor");
$__description["hostname"] = array("Nombre de anfitri&oacute;n");
...
$__description["DNS_template_name"] = array("Nombre de la plantilla DNS");
$__description["not_owner"] = array("No propietario");
$__description["real_owner"] = array("Propietario real");
$__description["used"] = array("Usado");
$__description["not_used"] = array("No useda");
$__description["web_ipaddress"] = array("Direcci&oacute;n IP web");
$__description["mail_ipaddress"] = array("Direcci&oacute;n IP correo electr&oacute;nico");
$__description["ipaddress"] = array("Direcci&oacute;n IP");
$__description["ttl_(seconds)"] = array("Ttl (segundos)");
$__description["primary_dns"] = array("dns primario");
$__description["ns_record"] = array("Registro NS");
$__description["a_record"] = array("Registro A");
$__description["mx_record"] = array("Registro MX");
$__description["cn_record"] = array("Registro CN");
$__description["type_of_dns_zone_file"] = array("Tipo de archivo de zona DNS");
$__description["primary_DNS"] = array("DNS primario");
$__description["new_dns_template"] = array("Nueva plantilla Dns");
$__description["secondary_DNS"] = array("DNS secundario");
$__description["SOA_nameserver"] = array("Servidor de nombres SOA");
$__description["general_settings"] = array("Configuraciones generales");
$__description["rebuild"] = array("Reconstruir");
$__description["DNS"] = array("DNS");
$__description["domain_name"] = array("Nombre de dominio");
$__description["manage_dns"] = array("Administrar Dns");
$__description["dns"] = array("Dns");
$__description["all_dns"] = array("Todas las Dns");
$__description["notification"] = array("Notificaci&oacute;n");
$__description["event_name"] = array("Nombre de evento");
$__description["notify_me_when_ticket_is_added"] = array("Notificarme cuando un ticket es a&ntilde;adido");
$__description["notify_me_when_ticket_changes"] = array("Notificarme cuando un ticket cambie");
$__description["notify_when_accounts_are_added_to_my_account"] = array("Notificarme cuando se a&ntilde;adan cuentas a mi cuenta");
$__description["notify_when_accounts_are_deleted_from_my_account"] = array("Notificarme cuando se  borren cuentas de mi cuenta");
$__description["notify_me_when_these_are_added_anywhere"] = array("Noficarme cuando se a&ntilde;ada en cualquier lugar");
$__description["description"] = array("Descripci&oacute;n");
$__description["welcome_message_for_new_accounts"] = array("Mensaje de bienvenida para nuevas cuentas");
$__description["welcome_message_subject"] = array("Asunto del mensaje de bienvenida");
$__description["welcome_message_from"] = array("Mensaje de bienvenida desde");
$__description["configure_notification"] = array("Configuraci&oacute;n de nofiticaci&oacute;n");
$__description["help_desk"] = array("Ayuda de escritorio");
$__description["favorite"] = array("Favorito");
$__description["link"] = array("Enlace");
$__description["default_description"] = array("Descripci&oacute;n por defecto");
$__description["separatorid"] = array("Id de separador");
$__description["sortid"] = array("Id de ordenaci&oacute;n");
...
$__description["Open"] = array("Abierto");
$__description["fixed"] = array("Arreglado");
$__description["E:escalate"] = array("E:Escalar");
$__description["Off"] = array("Apagado");
$__description["On"] = array("Encendido");
$__description["analyzed"] = array("Analizado");
$__description["closed"] = array("Cerrado");
$__description["p:priority"] = array("P:Prioridad");
$__description["low"] = array("Bajo");
$__description["medium"] = array("Medio");
$__description["high"] = array("Alto");
$__description["urgent"] = array("Urgente");
$__description["responsible"] = array("Responsable");
$__description["category"] = array("Categor&iacute;a");
$__description["sub_category"] = array("Subcategor&iacute;a");
$__description["created_by"] = array("Creado por");
$__description["replies"] = array("Respuestas");
$__description["sent_to:send_to"] = array("Enviado a:Enviado a");
$__description["subject"] = array("Asunto");
$__description["modified_on"] = array("Modificado en");
$__description["unread"] = array("Sin leer");
$__description["read"] = array("Leer");
$__description["close"] = array("Cerrar");
$__description["escalate"] = array("Escalar");
$__description["show_nonclosed"] = array("Mostrar no cerrados");
$__description["show_open"] = array("Mostrar abiertos");
$__description["show_all"] = array("Mostrar todo");
$__description["show_mine"] = array("Mostrar mios");
$__description["CPS:cp status"] = array("CPS:Cp Estado");
$__description["disabled"] = array("Desactivado");
$__description["enabled"] = array("Activado");
...
$__description["wholesale_reseller"] = array("Revendedor distribuidor ");
$__description["master_reseller"] = array("Revendedor master ");
$__description["admin"] = array("Administrador");
$__description["superadmin"] = array("Superadministrador");
$__description["password"] = array("Contrase&ntilde;a");
$__description["new_plan"] = array("Nuevo plan");
$__description["plan_name"] = array("Nombre del plan");
$__description["comments"] = array("Comentarios");
$__description["extra_email"] = array("Correo electr&oacute;nico extra");
$__description["disable_when_usage_reaches_(percentage)"] = array("Desactivar cuando el uso alcance (porcentaje) ");
$__description["old_password"] = array("Contrase&ntilde;a vieja");
$__description["real_name"] = array("Nombre real");
$__description["address"] = array("Direcci&oacute;n");
$__description["city"] = array("Ciudad");
$__description["country"] = array("Pa&iacute;s");
$__description["telephone_no"] = array("N&uacute;mero de tel&eacute;fono");
$__description["fax"] = array("Fax");
$__description[""] = array("");
$__description["limit"] = array("L&iacute;mite");
$__description["appearance"] = array("Apariencia");
$__description["backup"] = array("Respaldo");
$__description["cp_disable"] = array("Desactivar Cp");
$__description["cp_enable"] = array("Activar Cp");
$__description["change_plan"] = array("Cambiar plan");
$__description["login_options"] = array("Opciones de acceso");
$__description["demo_status"] = array("Demo de estado");
$__description["disable_policy"] = array("Desactivar pol�tica");
$__description["details"] = array("Detalles");
$__description["resend_welcome_message"] = array("Reenviar mensaje de bienvenida");
$__description["login_as"] = array("Acceso como");
$__description["action_log"] = array("Registro de accione");
$__description["class"] = array("Clase");
$__description["objectname"] = array("Nombre de objeto");
$__description["action"] = array("Acci&oacute;n");
$__description["subaction"] = array("Subacci&oacute;n");
$__description["loginid"] = array("Id de acceso");
$__description["auxiliary"] = array("Auxiliar");
$__description["reply"] = array("Contestar");
$__description["ticket_name"] = array("Nombre del ticket");
$__description["ticket_state_from"] = array("Estado del ticket desde");
$__description["state"] = array("Estado");
$__description["changed_by"] = array("Cambiado por");
$__description["text_reason"] = array("Raz&oacute;n de texto");
$__description["database_types"] = array("Tipos de bases de datos");
$__description["driver"] = array("Controlador");
$__description["driver_configuration"] = array("Configuraci&oacute;n del controlador");
$__description["login_history"] = array("Historial de acceso");
$__description["name"] = array("Nombre");
$__description["ip_address"] = array("Direcci&oacute;n IP");
$__description["login_time"] = array("Tiempo de entrada");
$__description["logout_time"] = array("Tiempo de salida");
$__description["auxiliary_id"] = array("ID auxiliar");
$__description["consuming_parent"] = array("Consumiendo parentesco");
$__description["logout_reason"] = array("Raz�n de desconexi�n");
$__description["Information"] = array("Informaci�n");
$__description["."] = array(".");
$__description["permission"] = array("Permiso");
$__description["s"] = array("S");
$__description["under_limit"] = array("Bajo l&iacute;mite");
$__description["exceeded"] = array("Excedido");
$__description["resourceused"] = array("Recurso usado");
$__description["S"] = array("S");
$__description["status_is_on"] = array("El estado es encendido");
$__description["status_is_off"] = array("El estado es apagado");
$__description["resource_usage"] = array("Consumo de recursos");
$__description["alright"] = array("Bien");
$__description["resource"] = array("Recurso");
$__description["max"] = array("Max");
$__description["graph"] = array("Gr&aacute;fica");
$__description["raw_connection"] = array("Conexi&oacute;n cruda");
$__description["success/failure"] = array("&Eacute;xito/Fallo");
$__description["time"] = array("Tiempo");
$__description["service"] = array("Servicio");
$__description["connection"] = array("Conexi&oacute;n");
...
$__description["text_description"] = array("Descripci&oacute;n de texto");
$__description["ftp_server"] = array("Servidor Ftp");
$__description["ssh_server"] = array("Servidor Ssh");
$__description["username"] = array("Nombre de usuario");
...
$__description["schedule_backup"] = array("Programar respaldo");
$__description["backup_from_file"] = array("Respaldo desde archivo");
...
$__description["last_backup_status"] = array("Estado del &uacute;ltimo respaldo");
$__description["last_restore_status"] = array("Estado de la �ltima restauraci&oacute;n");
...
$__description["last_access"] = array("&Uacute;ltimo acceso");
...
$__description["enable_mail"] = array("Activar correo electr&oacute;nico");
$__description["license"] = array("Licencia");
$__description["Ipaddress"] = array("Ipaddress");
$__description["Client Account"] = array("Cuenta de cliente");
$__description["Password"] = array("Password");
$__description["number_of_clients"] = array("N&uacute;mero de clientes");
$__description["number_of_servers"] = array("N&uacute;mero de servidores");
$__description["number_of_domains"] = array("N&uacute;mero de dominios");
$__description["number_of_vpses"] = array("N&uacute;mero de VPS");
$__description["expiry_date"] = array("Fecha de expiraci&oacute;n");
$__description["live_support"] = array("Soporte directo");
$__description["client_support"] = array("Client Support");
$__description["number_of_nodes"] = array("N&uacute;mero de nodos");
$__description["upload_new_license"] = array("Subir nueva licencia");
$__description["login_info"] = array("Informaci&oacute;n de acceso");
$__description["license_update"] = array("Actualizaci&oacute;n de licencia");
$__description["module"] = array("M&oacute;dulo");
$__description["module_name"] = array("Nombre de m&oacute;dulo");
$__description["module_information"] = array("Informaci&oacute;n de m&oacute;dulo");
$__description["skin"] = array("Tema");
$__description["skin_color"] = array("Color de tema");
$__description["icon_name"] = array("Nombre de icono");
$__description["current_logo_url"] = array("Url del logo actual");
...
$__description["english"] = array("Ingl�&eacute;s");
$__description["disable_ability_to_set_docroot"] = array("Disable Ability To Set Docroot");
$__description["log_into_domain_owner_mode"] = array("Acceder como modo propiertario de dominios");
...
$__description["ssl_port"] = array("Puerto SSL");
$__description["plain_port"] = array("Puerto est&aacute;ndar");
$__description["disable_plainport"] = array("Deactivar puerto est&aacute;ndar");
...
$__description["help_url"] = array("URL de ayuda");
...
$__description["day_of_week"] = array("D&iacute;a de la semana");
...
$__description["user_name"] = array("Nombre de usuario");
$__description["syncserver"] = array("Sincronizar servidor");
...
$__description["file"] = array("Archivo");
$__description["file_name"] = array("Nombre de archivo");
$__description["previous"] = array("Previo");
$__description["trash"] = array("Basura");
...
$__description["image"] = array("Imagen");
$__description["height"] = array("Alto");
$__description["width"] = array("Ancho");
...
$__description["process"] = array("Procesos");
$__description["pid"] = array("Pid");
$__description["sleeping"] = array("Durmiendo");
...
$__description["service_started_at_boot"] = array("Servicio iniciado al inicio");
$__description["service_not_started_at_boot"] = array("Servicio no iniciado al inicio");
...
$__description["usage"] = array("Consumo");
...
$__description["full_access"] = array("Acceso completo");
...
$__description["Old_version"] = array("Versi&oacute;n vieja");
$__description["Newer_Version"] = array("Versi&oacute;n nueva");
$__description["critical"] = array("Cr&iacute;tico");
...
$__description["package_name"] = array("Nombre del paquete");
...
$__description["database_user"] = array("Usuario de la base de datos");
$__description["database_user_name"] = array("Database User Name");
$__description["resource_plan"] = array("Planes de recurso");
$__description["internal_name"] = array("Nombre interno");
$__description["client_plan"] = array("Plan de cliente");
$__description["copy_to_this_client"] = array("Copiar a este cliente");
$__description["newname"] = array("Nuevo nombre");
$__description["share:share_this_plan_with_your_children"] = array("Compartir:Compartir este plan con tu hijo");
$__description["plan_is_shared"] = array("El plan es compartido");
$__description["plan_is_not_shared"] = array("El plan no es compartido");
$__description["openvz_template_list"] = array("Lista de plantillas de Openvz");
$__description["xen_template_list"] = array("Lista de plantillas de Xen");
$__description["accounts_on_this_plan"] = array("Cuentas en este plan");
...
$__description["accounts_on_plan"] = array("Cuentas en el plan");
...
$__description["enable_statistics"] = array("Activar estad&iacute;sticas");
$__description["can_change_logo"] = array("Puede cambiar logo");
...
$__description["Traffic:Traffic_(MB/Month)"] = array("Tr&aacute;fico:Tr&aacute;fico (MB/Mes)");
...
$__description["enable_php_fastcgi"] = array("Activar Php Fastcgi");
$__description["phpfcgi:number_of_fastcgi_process"] = array("Phpfcgi:Number Of Fastcgi Process");
$__description["allow_minute_management_for_cron"] = array("Permitir administraci�n detallada para Cron");
$__description["mysqldb:mysql_databases"] = array("Mysqldb:Mysql Databases");
$__description["pointer:number_of_pointer_domains"] = array("Apuntado:N&uactue;mero de dominios apuntados");
$__description["enable_installapp"] = array("Activar instalar aplicaciones");
$__description["enable_ssl"] = array("Activar Ssl");
$__description["can_change_limit"] = array("Puede cambiar l&iacute;mite");
$__description["enable_web_hosting"] = array("Activar hospedaje Web");
$__description["enable_frontpage"] = array("Activar Frontpage");
$__description["enable_cgi"] = array("Activar Cgi");
$__description["enable_php"] = array("Activar Php");
$__description["can_manage_dns"] = array("Puede administrar DNS");
$__description["allow_scheduler_management"] = array("Permitir administraci&oacute;n del planificador");
...
$__description["can_add_domains"] = array("Puede a�adir dominios");
...
$__description["All_assigned"] = array("Todo asignado");
...
$__description["mime_type"] = array("Tipos MIME");
...
$__description["Kloxo License"] = array("Licencia Kloxo");
$__description["Kloxo license"] = array("Licencia Kloxo");
...
$__description["watchdog"] = array("Temporizador controlador");
...
$__description["remove"] = array("Eliminar");
$__description["SSH_config"] = array("SSH Config");
$__description["SSH_port"] = array("SSH Port");
...
$__description["white_list"] = array("Lista blanca");
...
$__description["mail_servers"] = array("Servidores de correo electr&oacute;nico");
...
$__description["application"] = array("Aplicaci&oacute;n");
$__description["Installed"] = array("Instalado");
$__description["Not Installed"] = array("Not Installed");
$__description["ftp_traffic_(MB)"] = array("Tr&aacute;fico Ftp (MB)");
$__description["web_(MB)"] = array("Web (MB)");
$__description["mail_(MB)"] = array("Correo electr&oacute;nico (MB)");
$__description["mail"] = array("Correo electr&oacute;nico");
...
$__description["enable_SPF"] = array("Activar SPF");
...
$__description["clientname"] = array("Nombre de cliente");
...
$__description["totdisk"] = array("Espacio total en disco");
$__description["domains"] = array("Dominios");
$__description["mysql"] = array("Mysql");
$__description["resource_plan_name"] = array("Nombre del plan de recursos");
$__description["send_mail_to"] = array("Enviar correo electr&oacute;nico a");
$__description["from"] = array("Desde");
...
$__description["reload_module_info"] = array("Recargar informaci&oacute;n de m&oacute;dulo");
$__description["Advanced"] = array("Avanzado");
$__description["shell_access"] = array("Acceso Shell");
$__description["skeleton_and_disable"] = array("Skeleton y desactivar");
$__description["date:date_of_registration"] = array("Date:Fecha de registraci&oacute;n");
$__description["current_license_string"] = array("Cadena de licencia actual");
$__description["server_to_delete"] = array("Servidor para borrar");
...
$__description["disable_admin_login"] = array("Desactivar acceso administrador");
...
$__description["Traffic"] = array("Tr&aacute;fico");
$__description["default_domain"] = array("Dominio por defecto");
$__description["installatron"] = array("Installatron");
$__description["all"] = array("Todo");
$__description["all_client"] = array("Todo cliente");
$__description["display_errors"] = array("Mostrar errores");
$__description["register_globals"] = array("Register Globals");
$__description["enable_zend"] = array("Activar Zend");
$__description["enable_xcache"] = array("Activar Xcache");
$__description["enable_ioncube"] = array("Activar Ioncube");
...
$__description["log"] = array("Registro");
...
$__description["parked"] = array("Apuntado");
$__description["redirected"] = array("Redirigido");
...
$__description["config"] = array("Configuraci&oacuten");
$__description["rails_app"] = array("Aplicaci&oacute;n Rails");
$__description["applicationname"] = array("Nombre de aplicaci&oacute;n");
$__description["accessible_directly"] = array("Accessible Directly");
$__description["path"] = array("Ruta");
