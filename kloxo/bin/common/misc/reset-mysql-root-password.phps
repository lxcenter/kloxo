...
print("Starting MySQL server with --skip-grant-tables ...\n");
...
while($return) {
	print("Could not connect to MySQL server, sleep for 10 seconds and retry...\n");
	sleep(10);
	system("echo \"update user set password = Password('$pass') where User = 'root'\" | mysql -u root mysql", $return);
}

print("Password reset done. Now killing MySQL Server softly...\n");
	shell_exec("killall mysqld");
print("Wait 10 seconds...\n");
	shell_exec("sleep 10");
print("Restarting MySQL in normal mode...\n");
