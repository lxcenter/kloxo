<?php
/**
 * $Horde: ingo/lib/Script/maildrop.php,v 1.7.2.17 2011/01/25 17:53:45 slusarz Exp $
 *
...
class Maildrop_Recipe {
    ...
    function Maildrop_Recipe($params = array(), $scriptparams = array())
    {
        ...
        case INGO_STORAGE_ACTION_VACATION:
            ...
            $driver->_connect();
            $result = $driver->_vfs->writeData($driver->_params['vfs_path'], 'vacation.msg', $params['action-value']['reason'], true);
