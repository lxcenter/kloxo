...
syn cluster chtmlTop contains=@
cFormat, cCppString, cCommentL, cCommentStart, cLabel, cUserLabel, cConditional, cRepeat, cCharacter, cSpecialCharacter, cNumber, cOctal, cOctalZero, cFloat, cOctalError, cParenError, cErrInParen, cErrInBracket, cCommentError, cCommentStartError, cSpaceError, cSpecialError, cOperator, cStructure, cStorageClass, cInclude, cPreProc,
cDefine,
cIncluded,
cError,
cStatement,
