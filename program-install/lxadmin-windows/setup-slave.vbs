...
Const HttpSrclxa = "http://download.lxlabs.com/download/lxadmin-install.zip"
...
If ObjFS.FileExists("lxadmin-install.zip") Then
 	ObjFS.deleteFile("lxadmin-install.zip")
End If

Call downloadphp(HttpSrclxa, "lxadmin-install.zip")
Call unziphpFile("lxadmin-install.zip")
Call runPhp()
...
'Running main Lxadmin installation File
 WSHShell.Run ("C:\Lxainstall\initial-php\php.exe  C:\Lxainstall\lxadmin-install\wininstall.php"),4,1
 MsgBox " Running Done"
End Sub
