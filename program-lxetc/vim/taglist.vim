...
function! s:Tlist_Init_Window()
	...
	" Ligesh Mapping
nnoremap <buffer> <silent> o :call <SID>Tlist_Jump_To_Tag(0)<CR>
nnoremap <buffer> <silent> p :call <SID>Tlist_Jump_To_Tag(1)<CR>
nnoremap <buffer> <silent> <CR> :call <SID>Tlist_Jump_To_Tag(2)<CR>
nnoremap <buffer> <silent> s :call <SID>Tlist_Change_Sort()<CR>
nnoremap <buffer> <silent> = :silent! foldopen<CR>
nnoremap <buffer> <silent> - :silent! foldclose<CR>
nnoremap <buffer> <silent> * :silent! %foldopen!<CR>
...
function! s:Tlist_Open_File(win_ctrl, filename, tagpat)
	...
	" Ligesh
	let  line = line('.')
	call search('^\*\s\+@desc', "bW")
	let newl = line('.')
	let difference = line - newl
	echo difference
	if (difference > 10) 
		exe ':' . line	
	else 
