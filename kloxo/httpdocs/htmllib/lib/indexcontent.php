...
if (lxfile_exists("__path_program_htmlbase/lib/indexheader_vendor.html")) {
	include_once("lib/indexheader_vendor.html");
} else {
	include_once("lib/indexheader.html");
}
...
<div id="ctr" align="center">
	<div class="login">
		<div class="login-form">
			<div align="center">
				<h1><b><?php echo _('Forgot Password');?></b></h1></div>
			<br>
			...
			<form name="sendmail" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
				<div class="form-block">
					...
					<div align="left">
					<input type="submit" class="button" name="forgot" value="<?php echo _('Send');?>"/>
					</div>
				</div>
				<div align="right">
					<a class="forgotpwd" href="javascript:history.go(-1);"><h2><?php echo _('Back to login'); ?></h2></a>
				</div>
		</div>
		<div class="login-text">
