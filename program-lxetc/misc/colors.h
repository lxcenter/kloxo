...
#define BUTTON_ACTIVE_FG             COLOR_CYAN
#define BUTTON_ACTIVE_BG             COLOR_BLACK
#define BUTTON_ACTIVE_HL             TRUE

#define BUTTON_INACTIVE_FG           COLOR_WHITE
#define BUTTON_INACTIVE_BG           COLOR_BLACK
#define BUTTON_INACTIVE_HL           FALSE

#define BUTTON_KEY_ACTIVE_FG         COLOR_CYAN
#define BUTTON_KEY_ACTIVE_BG         COLOR_BLACK
#define BUTTON_KEY_ACTIVE_HL         TRUE

#define BUTTON_KEY_INACTIVE_FG       COLOR_WHITE
#define BUTTON_KEY_INACTIVE_BG       COLOR_BLACK
#define BUTTON_KEY_INACTIVE_HL       FALSE

#define BUTTON_LABEL_ACTIVE_FG       COLOR_BLACK
#define BUTTON_LABEL_ACTIVE_BG       COLOR_BLACK
#define BUTTON_LABEL_ACTIVE_HL       TRUE

#define BUTTON_LABEL_INACTIVE_FG     COLOR_WHITE
#define BUTTON_LABEL_INACTIVE_BG     COLOR_BLACK
#define BUTTON_LABEL_INACTIVE_HL     TRUE

#define INPUTBOX_FG                  COLOR_WHITE
#define INPUTBOX_BG                  COLOR_BLACK
#define INPUTBOX_HL                  FALSE

#define INPUTBOX_BORDER_FG           COLOR_WHITE
#define INPUTBOX_BORDER_BG           COLOR_BLACK
#define INPUTBOX_BORDER_HL           FALSE

#define SEARCHBOX_FG                 COLOR_WHITE
...
#define ITEM_SELECTED_FG             COLOR_CYAN
#define ITEM_SELECTED_BG             COLOR_BLACK
...
#define TAG_SELECTED_BG              COLOR_BLACK
...
#define TAG_KEY_SELECTED_BG          COLOR_BLACK
#define TAG_KEY_SELECTED_HL          TRUE

#define CHECK_FG                     COLOR_WHITE
#define CHECK_BG                     COLOR_BLACK
#define CHECK_HL                     FALSE

#define CHECK_SELECTED_FG            COLOR_YELLOW
#define CHECK_SELECTED_BG            COLOR_BLACK
#define CHECK_SELECTED_HL            TRUE

#define UARROW_FG                    COLOR_CYAN
#define UARROW_BG                    COLOR_BLACK
#define UARROW_HL                    TRUE

#define DARROW_FG                    COLOR_CYAN
